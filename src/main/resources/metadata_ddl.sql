...
/*
Digital Hub Scalar Table
*/
CREATE TABLE LUM_MD_DIGI_HUB_INFO(
	UOI_ID nvarchar(40) NOT NULL,
	WCMS_CONFIDENTIALITY nvarchar(20) NULL
);

ALTER TABLE LUM_MD_DIGI_HUB_INFO  
WITH CHECK ADD CONSTRAINT LUM_MD_DIGI_HUB_INFO_FK FOREIGN KEY(UOI_ID)
REFERENCES UOIS (UOI_ID) ON DELETE CASCADE;

ALTER TABLE LUM_MD_DIGI_HUB_INFO CHECK CONSTRAINT LUM_MD_DIGI_HUB_INFO_FK;

INSERT INTO METADATA_TABLE_INCLUSIONS VALUES ('LUM_MD_DIGI_HUB_INFO','N',NULL);


/*
Digital Hub Information Tabular table
 */
CREATE TABLE LUM_MD_DIGI_HUB_INFO_TAB(
	UOI_ID nvarchar(40) NOT NULL,
	PUBLISH_TO_MICROSITE nvarchar(100) NULL
);

ALTER TABLE LUM_MD_DIGI_HUB_INFO_TAB  
WITH CHECK ADD CONSTRAINT LUM_MD_DIGI_HUB_INFO_TAB_FK FOREIGN KEY(UOI_ID)
REFERENCES UOIS (UOI_ID) ON DELETE CASCADE;

ALTER TABLE LUM_MD_DIGI_HUB_INFO_TAB CHECK CONSTRAINT LUM_MD_DIGI_HUB_INFO_TAB_FK;

INSERT INTO METADATA_TABLE_INCLUSIONS VALUES ('LUM_MD_DIGI_HUB_INFO_TAB','Y',NULL);

/*
Look up domain for Publish to microsite
*/
CREATE TABLE LUM_MD_PUB_TO_MICROSITE_LU(
	ID nvarchar(40) NOT NULL,
	VALUE nvarchar(40) NOT NULL,
	DESCRIPTION nvarchar(200) NULL,
	CONSTRAINT LUM_MD_PUB_TO_MICROSITE_LU_PK PRIMARY KEY CLUSTERED 
(
	ID ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
);
 
INSERT INTO LOOKUP_TABLE_INCLUSIONS values ('LUM_MD_PUB_TO_MICROSITE_LU');
